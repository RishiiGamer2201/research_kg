...
def links2subgraphs(A, graphs, params, max_label_value=None):
    ...
    map_size = max(int(links_length * BYTES_PER_DATUM), 1 << 30)
    ...
    def extraction_helper(A, links, g_labels, split_env):
        ...
        worker_count = params.num_workers if getattr(params, 'num_workers', None) and params.num_workers > 0 else 1
        with mp.Pool(processes=worker_count, initializer=intialize_worker, initargs=(A, params, max_label_value)) as p:
