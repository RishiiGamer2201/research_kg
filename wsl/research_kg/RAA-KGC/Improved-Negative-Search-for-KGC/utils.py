...
def save_checkpoint(state: dict, is_best: bool, filename: str, best_filename: str = 'model_best.mdl',
                    last_filename: str = 'model_last.mdl'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, os.path.dirname(filename) + '/' + best_filename)
    shutil.copyfile(filename, os.path.dirname(filename) + '/' + last_filename)
